                  ...
                  <div className="sm:col-span-1">
                    ...
                    <div className="relative">
                      ...
                      <div
                        ...
                        <svg className="size-4 text-gray-400" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="flex justify-end gap-x-2">
                      ...
                      <span className="block py-2 px-3 text-xs font-medium uppercase text-gray-400 dark:text-gray-600">
                        Options
                            ...
                            <a className="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                               href="#">
                              <svg className="size-4" xmlns="http://www.w3.org/2000/svg"
                      ...
                      <div className="hs-dropdown relative inline-block [--placement:bottom-right]"
                        ...
                        <button id="hs-as-table-table-filter-dropdown" type="button"
                          ...
                          Filter
                          <span
                              className="ps-2 text-xs font-semibold text-blue-600 border-s border-gray-200 dark:border-gray-700 dark:text-blue-500">
                      1
                    </span>
                        </button>
                        <div
                          ...
                          <div className="divide-y divide-gray-200 dark:divide-gray-700">
                            <label htmlFor="hs-as-filters-dropdown-all"
                              ...
                              <span
                                  className="ms-3 text-sm text-gray-800 dark:text-gray-200">All</span>
                            </label>
                            <label htmlFor="hs-as-filters-dropdown-paid"
                                   className="flex py-2.5 px-3">
                              <input type="checkbox"
                                     className="shrink-0 mt-0.5 border-gray-300 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-600 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                                     id="hs-as-filters-dropdown-paid"/>
                              <span
                                  className="ms-3 text-sm text-gray-800 dark:text-gray-200">Paid</span>
                            </label>
                            <label htmlFor="hs-as-filters-dropdown-pending"
                                   className="flex py-2.5 px-3">
                              <input type="checkbox"
                                     className="shrink-0 mt-0.5 border-gray-300 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-600 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                                     id="hs-as-filters-dropdown-pending"/>
                              <span
                                  className="ms-3 text-sm text-gray-800 dark:text-gray-200">Pending</span>
                            </label>
                            <label htmlFor="hs-as-filters-dropdown-declined"
                                   className="flex py-2.5 px-3">
                              <input type="checkbox"
                                     className="shrink-0 mt-0.5 border-gray-300 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-600 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                                     id="hs-as-filters-dropdown-declined"/>
                              <span
                                  className="ms-3 text-sm text-gray-800 dark:text-gray-200">Declined</span>
                            </label>
                          </div>
                        </div>
                      </div>
                      ...
                      <tr>
                        <td className="size-px whitespace-nowrap">
                          <div className="px-6 py-2">
                            <Link to={`/clients/${client.DestinationIPAddress}`} className="text-sm text-blue-600 decoration-2 hover:underline dark:text-blue-500">{client.DestinationIPAddress}</Link>
                          </div>
                        </td>
                        <td className="size-px whitespace-nowrap">
                          <div className="px-6 py-2">
